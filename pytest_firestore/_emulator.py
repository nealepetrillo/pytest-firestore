"""Firestore emulator subprocess management with xdist coordination."""
...
class EmulatorInfo:
    """Connection details for a running Firestore emulator."""
...
class FirestoreEmulator:
    """Manages the lifecycle of a GCP Firestore emulator subprocess.
    ...
    def _start_shared(self) -> EmulatorInfo:
        ...
        lock_path = self._shared_dir / "firestore_emulator.lock"
        state_path = self._shared_dir / "firestore_emulator.json"
